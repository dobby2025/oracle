...
INSERT INTO test_table (no, subject, contents)
VALUES (my_seq.NEXTVAL, '안녕하세요', '시퀀스 테스트중입니다.');
...
인덱스(INDEX)
    ...
    정렬하여 저장하는 구조로, 데이터 조회 성능을 향상 시키는데 사용됩니다.
...
ROWNUM  : 쿼리의 결과의 각 행에 순차적인 번호를 할당해줍니다.
*/
